...
#SBATCH --job-name=rnn-base                    # Submit a job named "example"
...
#SBATCH --cpus-per-task=4                     # Using 4 maximum processor JOB ID : 122796
...
srun python3 -m neuralDecoder.main \
    ...
    outputDir=/home/s2/nlp002/pj_data/derived/rnn-base/baselineRelease