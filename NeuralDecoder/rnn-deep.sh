...
#SBATCH --job-name=rnn-deep                    # Submit a job named "example"
...
#SBATCH --cpus-per-task=8                     # Using 4 maximum processor JOB ID : 122801
...
srun python3 -m neuralDecoder.main \
    ...
    outputDir=/home/s2/nlp002/pj_data/derived/rnn-deep/baselineRelease